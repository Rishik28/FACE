const CACHE='face-shell-v1';
const SHELL=['./','./index.html','./styles.css','./arcade.css','./game.js','./js/config.js','./js/effects.js','./manifest.webmanifest','./assets/this-man-frame.png','./assets/animations/blink.gif'];
